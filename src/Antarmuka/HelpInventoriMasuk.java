...
import Antarmuka.InventarisKeluar;
import Antarmuka.HelpInventoriMasuk;
/**
 *
 * @author ivana
 */
public class HelpInventoriMasuk extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
       
    public InventarisKeluar invmsk = null;
   
    public HelpInventoriMasuk() {
        initComponents();
        datatable();
    }
    ...
    private void datatable() {
        ...
        try {
            String sql = "SELECT a.kd_inventaris_masuk, b.kd_barang, b.nama_barang, b.kategori_barang, b.merek"
             + " FROM tbl_inventarismasuk a"
             + " JOIN tbl_barang b ON a.kd_barang = b.kd_barang"
             + " WHERE a.kd_inventaris_masuk LIKE '%" + cariitem + "%'"
             + " OR b.kd_barang LIKE '%" + cariitem + "%'"
             + " OR b.nama_barang LIKE '%" + cariitem + "%'"
             + " ORDER BY kd_inventaris_masuk ASC";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpInventoriMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpInventoriMasuk().setVisible(true);
            }
        });
    }
