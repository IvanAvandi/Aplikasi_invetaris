...
import Antarmuka.InventarisMasuk;

/**
 *
 * @author ivana
 */
public class HelpBarang extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpBarang().setVisible(true);
            }
        });
    }
